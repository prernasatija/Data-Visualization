...
AmCharts.AmChart = AmCharts.Class({
    ...
    brr: function() {
        ...
        if ("amcharts.com" != b || !0 === this.inIframe()) {
            ...
            "ammap" == this.product && (e = "http://www.ammap.com/javascript-maps/", g = "Interactive JavaScript maps", h = "");
    ...
    draw: function() {
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                ...
                this.className && (m.className = m.className + " " + u + "-balloon-div-" + this.className);
                u = m.style;
...
AmCharts.wedge = function(a, b, c, d, f, e, g, h, k, l, m, n) {
    ...
    0 < k && (D = " M" + y + "," + (B + k) + " L" + A + "," + (w + k), z ? (F || (D += " A" + (b - e) + "," + (k + c - g) + "," + (b + e) + "," + (k + c + g) + "," + A + "," + (w + k) + "," + r + "," + (u + k)), D += " L" + q + "," + (v + k), 0 < h && (F || (D += " B" + (b - h) + "," + (k + c - p) + "," + (b + h) + "," + (k + c + p) + "," + q + "," + (k + v) + "," + y + "," + (k + B)))) : (D += " A" + e + "," + g + ",0," + C + ",1," + r + "," + (u + k) + " L" + q + "," + (v + k), 0 < h && (D += " A" + h + "," + p + ",0," + C + ",0," + y + "," + (B + k))), D = a.path(D + " Z", void 0, void 0, "1000,1000").attr(x), d.push(D), D = a.path(" M" + y + "," + B + " L" + y + "," + (B + k) + " L" + A + "," + (w + k) + " L" + A + "," + w + " L" + y + "," + B + " Z", void 0, void 0, "1000,1000").attr(x), k = a.path(" M" + r + "," + u + " L" + r + "," + (u + k) + " L" + q + "," + (v + k) + " L" + q + "," + v + " L" + r + "," + u + " Z", void 0, void 0, "1000,1000").attr(x), d.push(D), d.push(k));
    z ? (F || (f = " A" + t(b - e) + "," + t(c - g) + "," + t(b + e) + "," + t(c + g) + "," + t(A) + "," + t(w) + "," + t(r) + "," + t(u)), e = " M" + t(y) + "," + t(B) + " L" + t(A) + "," + t(w) + f + " L" + t(q) + "," + t(v)) : e = " M" + y + "," + B + " L" + A + "," + w + (" A" + e + "," + g + ",0," + C + ",1," + r + "," + u) + " L" + q + "," + v;
...
AmCharts.AmLegend = AmCharts.Class({
    ...
    drawLegend: function() {
        ...
        this.titleWidth = 0;
        if (f = this.title) f = AmCharts.text(this.container, f, this.color, a.fontFamily, this.fontSize, "start", !0), AmCharts.setCN(a, f, "legend-title"), f.translate(this.marginLeft, this.marginTop + this.verticalGap + this.ly + 1), a = f.getBBox(), this.titleWidth = a.width + 15, this.titleHeight = a.height + 6;
    ...
    updateValues: function() {
        ...
        for (c = 0; c < a.length; c++) {
            ...
            if (d) e.value ? f.text(e.value) : f.text("");
                ...
                } else g = b.formatString(this.valueText, e); if (k = this.valueFunction) h && (e = h), g = k(e, g);
                f.text(g)
            }
        }
    },
...
AmCharts.AmMap = AmCharts.Class({
    ...
    initChart: function() {
        ...
        } else(AmCharts.AmMap.base.initChart.call(this), AmCharts.hasSVG) ? (this.dataChanged && (this.parseData(), this.dispatchDataUpdated = !0, this.dataChanged = !1, a = this.legend) && (a.position = "absolute", a.invalidateSize()), this.createDescriptionsDiv(), this.svgAreas = [], this.svgAreasById = {}, this.drawChart()) : (document.createTextNode(this.svgNotSupported), this.chartDiv.style.textAlign = "", this.chartDiv.setAttribute("class", "ammapAlert"), this.chartDiv.innerHTML = this.svgNotSupported, this.fire("failed", {
            type: "failed",
            chart: this
        }), clearInterval(this.interval))
    },
    ...
    selectObject: function(a) {
        //alert("123456");
        //var svgCircle = d3.select(this).append("svg").attr("width", 600) .attr("height", 800);
        //var circle = svgCircle.append("circle").style("stroke", "gray").style("fill", "white").attr("r", 40).attr("cx", 50).attr("cy", 50);
        var b = this;
        a || (a = b.dataProvider);
        a.isOver = !1;
...
AmCharts.AreasSettings = AmCharts.Class({
    construct: function(a) {
        ...
        this.alpha = 1;
        this.autoZoom = !1;
        this.balloonText = "[[title]]"; // MY CHART LABEL
        this.color = "#FFCC00";
...
AmCharts.ImagesProcessor = AmCharts.Class({
    ...
    createImage: function(a, b) {
        ...
        x = null;
        void 0 !== a.label && (x = AmCharts.text(d, a.label, a.labelColorReal, c.fontFamily, a.labelFontSizeReal, a.labelAlign), AmCharts.setCN(c, x, "map-image-label"), void 0 !== a.id && AmCharts.setCN(c, x, "map-image-label-" + a.id), C = a.labelBackgroundAlpha, (h = a.labelBackgroundColor) && 0 < C && (k = x.getBBox(), d = AmCharts.rect(d, k.width + 16, k.height + 10, h, C), AmCharts.setCN(c, d, "map-image-label-background"), void 0 != a.id && AmCharts.setCN(c, d, "map-image-label-background-" + a.id), q.push(d), a.labelBG = d), a.imageLabel = x, q.push(x), AmCharts.setCN(c, q, "map-image-container"), void 0 != a.id && AmCharts.setCN(c, q, "map-image-container-" +
            a.id));
